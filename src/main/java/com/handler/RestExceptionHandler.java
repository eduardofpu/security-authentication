...
public class RestExceptionHandler {
    ...
    @ExceptionHandler(ResourceNotFoundException.class)// o proprio spring vai se encarregar de ativar o exception handler
    ...
    @ExceptionHandler(MethodArgumentNotValidException.class)// o proprio spring vai se encarregar de ativar o exception handler
